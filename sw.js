const CACHE='dexbinder-shell-v090';
const APP_SHELL=[
  './',
  './index.html',
...
self.addEventListener('activate',event=>{
  const keep=new Set([CACHE,'dexbinder-data-v090','dexbinder-images-v090']);
  event.waitUntil(
    caches.keys()
...
const DATA_CACHE='dexbinder-data-v090';
const IMAGE_CACHE='dexbinder-images-v090';
